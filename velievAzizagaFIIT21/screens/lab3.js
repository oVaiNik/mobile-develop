...
import { View, Button ,Text, TextInput, FlatList, StyleSheet, SafeAreaView, TouchableOpacity} from 'react-native';
...
export default function Lab3() {
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      />
      <TouchableOpacity style={styles.footer} onPress={changeTextColor} color="#000">
